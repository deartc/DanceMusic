...
I used Window and SQL Express.   To run my project your must do the following: Go to github.com/deartc/DanceMusic.  Clone the repository.  Open in Sql compatabile program (  Ionly tested with SQL Express).  
